      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* TODO: implement download and share functionality */}
        ...
        >
          ...
          >
            {ticket.event.is_cancelled
              ? "For questions about refunds or cancellations, please contact our support team at help@ticketo.com."
              : "If you have any issues with your ticket, please contact our support team at help@ticketo.com."}
          </p>
        </div>
      </div>
    </div>
