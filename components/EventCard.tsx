...
const EventCard = ({ eventId }: { eventId: Id<"events"> }) => {
  ...
  // This generates a URL that returns the path to the stored image associated with the event.
  // The useStorageUrl is a helper function in lib/utils.ts that calls the getUrl query from the storage api.
  ...
  return (
    ...
    >
      ...
      {imageUrl && (
        <div className="relative w-full h-48">
          <Image
            ...
            priority
          />
          {/* Fading Black Shadow at the bottom of the image */}
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        ...
        {/* The e.stopPropagation() function is used so that lower level events do not activate
            the event handler set for the parent element of the card. */}
